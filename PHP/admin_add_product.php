        ...
        if (in_array($fileExtension, $allowedExts)) {
            ...
            if ($fileSize <= 5 * 1024 * 1024) {
                ...
                if (move_uploaded_file($fileTmpPath, $destPath)) {
                    ...
                    $sql = "INSERT INTO sanpham (name, image, type_id, category_id, season_id, quality, description) 
                            VALUES (?, ?, ?, ?, ?, ?, ?)";
                    
                    $stmt = $conn->prepare($sql);
                    if ($stmt) {
                        // param: string, string, int, int, int, string, string = "ssiiiss"
                        $stmt->bind_param("ssiiiss", $ten, $newFileName, $type_id, $category_id, $season_id, $chat_luong, $mo_ta);
    ...
    <div class="admin-form-container">
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="admin-form">
            ...
            <div class="form-group-grid">
                ...
                <!-- Phân loại -->
                <div class="form-group">
                    <label for="loai">Loại Trang Phục <span class="required">*</span></label>
                    <div class="select-wrapper">
