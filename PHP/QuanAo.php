...
$sqlNguoiLon = "SELECT * FROM sanpham WHERE type_id = 1 AND (TrangThai = 0 OR TrangThai IS NULL) ORDER BY MaSP DESC";
$resNguoiLon = $conn->query($sqlNguoiLon);

// Truy vấn sản phẩm Dành cho Trẻ em (type_id = 0)
$sqlTreEm = "SELECT * FROM sanpham WHERE type_id = 0 AND (TrangThai = 0 OR TrangThai IS NULL) ORDER BY MaSP DESC";
